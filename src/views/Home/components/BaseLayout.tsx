        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-[#022D3D] px-4 pb-4">
            <nav className="flex flex-col space-y-3">
              <a href="#home" className="hover:text-white py-2" onClick={() => setIsMobileMenuOpen(false)}>Home</a>
              <a href="#solucoes" className="hover:text-white py-2" onClick={() => setIsMobileMenuOpen(false)}>Soluções</a>
              <a href="#contato" className="hover:text-white py-2" onClick={() => setIsMobileMenuOpen(false)}>Contato</a>
            </nav>
